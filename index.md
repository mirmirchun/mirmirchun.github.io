...
<h1 class="homepage-name">
  <span class="first-name">Miriam</span> <span class="last-name">Chun</span>
</h1>

<img src="/profilephoto.jpg" alt="Miriam Chun" class="profile-photo-right">

I am a **systems-oriented social worker** studying the social impact of AI in capacity-building contexts.
...
* **Empowerment-Centered AI Evaluation:** Developing measurement criteria and benchmark tasks to evaluate whether LLM interactions support empowering processes, including informed choice, agency, strengths-based reasoning, resource navigation, contextual responsiveness, and sustainable capacity building.
